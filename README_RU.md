...
### Шаг 1: Регистрация на iflow.cn

1. Перейдите на сайт [iflow.cn](https://iflow.cn)
2. Нажмите кнопку регистрации

![Регистрация шаг 1](reg1.jpg)

![Регистрация шаг 2](reg2.jpg)

1. Следуйте инструкциям для создания аккаунта

### Шаг 2: Установка iFlow CLI
...
Следуйте инструкциям для авторизации через сайт.
