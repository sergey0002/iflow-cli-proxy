...
Простейший прокси-сервер, написанный на Go, позволяющий получить безлимитный доступ к GLM-5 и другим моделям, доступным в [iFlow CLI](https://iflow.cn), для ваших собственных целей в формате, совместимом с OpenAI API.
...
Прокси предоставляет доступ к следующим моделям в формате, совместимом с OpenAI API:

- `glm-5` - основная модель (GLM-5)
- `glm-4.7` - GLM-4.7
...
Все модели доступны через iFlow CLI и могут использоваться с безлимитными запросами.
